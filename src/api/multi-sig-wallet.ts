...
NOTE:
Every time an Ethereum address sends a transaction, it has to
set a value called the "nonce".
The Ethereum network will only accept (mine) transactions
in nonce order (0, 1, 2, 3, ...) and nonces cannot be skipped or repeated.
*/
